...
const sections = [
  {
    ...
    items: [
      ...
      "تمام محتوای وب‌سایت شامل کتاب‌ها، فایل‌های صوتی، ویدئوها و تمرین‌ها متعلق به لینگوفم بوده و هرگونه کپی‌برداری پیگرد قانونی دارد.",
  ...
  },
  {
    ...
    title: "رزرو کلاس‌ها",
    items: [
      "کلاس‌ها به دو صورت خصوصی و عمومی برگزار می‌شوند.",
      "کلاس خصوصی ۱.۵ ساعته و کلاس عمومی در قالب دوره‌های ۱۵ جلسه‌ای ارائه می‌شود.",
      "زمان و تاریخ کلاس خصوصی توسط کاربر انتخاب می‌شود.",
      "کلاس‌های عمومی در زمان‌های از پیش تعیین شده برگزار شده و از طریق پیامک یا ایمیل به کاربر اطلاع داده می‌شود.",
      ...
      "لینک جلسه آنلاین در تاریخ برگزاری کلاس در دسترس کاربر قرار می‌گیرد.",
    ],
  },
  {
    icon: Shield,
