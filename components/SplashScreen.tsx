    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          <div className="absolute top-1/2 left-1/2 w-[520px] h-[520px] rounded-full bg-[#22c55e]/15 blur-[140px] animate-splash-glow-center" />
          <div className="absolute -top-32 -right-32 w-[420px] h-[420px] rounded-full bg-[#16a34a]/10 blur-[120px] animate-splash-glow" style={{ animationDelay: "1.2s" }} />
          <div className="absolute -bottom-32 -left-32 w-[420px] h-[420px] rounded-full bg-[#4ade80]/10 blur-[120px] animate-splash-glow" style={{ animationDelay: "2s" }} />
